      ...
      <div className="mx-auto w-full max-w-[940px] px-6 py-24">
        <Reveal>
          <div className="mx-auto max-w-[560px] border border-border bg-surface p-10 text-center">
            ...
            <h2 className="text-[clamp(24px,4vw,34px)] leading-tight tracking-tight">get seashell</h2>
            ...
            <div className="mt-7 flex flex-wrap justify-center gap-3">
              ...
              <a href={REPO} className="flex h-11 items-center border border-border px-5 text-[15px] hover:border-muted">
                source &amp; docs
              </a>
            </div>

            <div className="mt-8 text-left">
              <p className="mb-2 mono text-[10.5px] tracking-[0.08em] text-faint">…or build it yourself</p>
